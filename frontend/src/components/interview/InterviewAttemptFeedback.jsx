...
export default function InterviewAttemptFeedback({
  ...
  return (
    <article className="rounded-panel border border-border bg-surface p-4 shadow-sm transition-colors sm:p-5">
      ...
      {isExpanded ? (
        <div className="mt-4 border-t border-border pt-4">
          ...
          <div className="rounded-surface bg-surface-secondary/70 p-4">
          ...
          {strengths.length || improvements.length ? (
            <div className="mt-4 space-y-4">
              {strengths.length ? (
                <div className="w-full rounded-surface border border-success/15 bg-success-soft p-4 text-sm text-success">
              ...
              {improvements.length ? (
                <div className="w-full rounded-surface border border-error/15 bg-error-soft p-4 text-sm text-error">
