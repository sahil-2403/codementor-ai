...
export const COURSE_STATUS = Object.freeze({ GENERATING: 'generating', ACTIVE: 'active', FAILED: 'failed', ARCHIVED: 'archived' });
...
export const JOB_STATUS = Object.freeze({ QUEUED: 'queued', PROCESSING: 'processing', COMPLETED: 'completed', FAILED: 'failed' });
...
export const ROADMAP_SETUP_STATES = Object.freeze([ONBOARDING_STATE.ROADMAP_PENDING, ONBOARDING_STATE.ROADMAP_GENERATING, ONBOARDING_STATE.ROADMAP_FAILED]);

const STATUS_TONE = Object.freeze({
  [CONTENT_STATUS.DRAFT]: 'warning', [CONTENT_STATUS.PUBLISHED]: 'success', [CONTENT_STATUS.ARCHIVED]: 'neutral',
  [COURSE_STATUS.GENERATING]: 'info', [COURSE_STATUS.ACTIVE]: 'success', [COURSE_STATUS.FAILED]: 'danger',
