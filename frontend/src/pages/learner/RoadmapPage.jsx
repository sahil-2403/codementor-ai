  ...
  return (
    <PageShell className="space-y-5 pb-6">
      ...
      <section className="overflow-hidden rounded-panel border border-primary/15 bg-gradient-to-br from-surface via-primary-soft/45 to-violet-50 shadow-sm">
        ...
        <div className="grid border-t border-primary/10 bg-white/40 sm:grid-cols-3">
          <div className="flex items-center gap-4 px-5 py-4 sm:px-6 sm:py-5">
            <span
              className="grid h-11 w-11 shrink-0 place-items-center rounded-control bg-primary-soft text-primary-strong"
              aria-hidden="true"
            >
              <Layers3 size={19} />
            </span>
          ...
          <div className="flex items-center gap-4 border-t border-primary/10 px-5 py-4 sm:border-l sm:border-t-0 sm:px-6 sm:py-5">
            <span
              className="grid h-11 w-11 shrink-0 place-items-center rounded-control bg-blue-50 text-blue-600"
              aria-hidden="true"
            >
          ...
          <div className="flex items-center gap-4 border-t border-primary/10  px-5 py-4 text-xs leading-5 text-muted-foreground sm:border-l sm:border-t-0 sm:px-6">
            <span
              className="grid h-11 w-11 shrink-0 place-items-center rounded-control bg-primary-soft text-primary-strong"
              aria-hidden="true"
            >
