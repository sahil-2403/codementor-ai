...
export default function TemplateEditorPage() {
  ...
  useEffect(() => {
    ...
    }).catch((requestError) => { if (active) setContentError(requestError); }).finally(() => { if (active) setContentLoading(false); });
    return () => { active = false; };
  }, [courseId]);
