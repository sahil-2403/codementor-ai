...
export default function TopicsPage() {
  ...
  return <PageShell>
    ...
    <ConfirmDialog open={Boolean(confirmDelete)} title="Delete topic?" description={`Delete “${confirmDelete?.title}” only if no lessons or questions are using it. The backend will block unsafe deletes.`} confirmLabel="Delete topic" isLoading={deleteTopic.isPending} onCancel={() => setConfirmDelete(null)} onConfirm={() => deleteTopic.mutate(confirmDelete._id, { onSuccess: () => setConfirmDelete(null) })} />
  </PageShell>;
}
