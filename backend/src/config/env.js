...
const envSchema = z.object({
  ...
  DAILY_PRACTICE_REVIEW_LIMIT: z.coerce.number().int().positive().default(5),
  ...
  MAX_PRACTICE_CODE_CHARS: z.coerce.number().int().positive().default(15000),
  MAX_PRACTICE_EXPLANATION_CHARS: z.coerce.number().int().positive().default(4000),
